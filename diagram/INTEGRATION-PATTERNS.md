...
Which SDK pieces to combine depends on what your dApp needs: gate by individual KYC, gate by business KYB, onboard new users, or verify a one-off proof. This document gives the decision tree (visual diagram in [`decision-tree.png`](decision-tree.png)) and the recommended pattern for each path.

## Decision tree

![EligibilitySDK integration decision tree](decision-tree.png)
